...
pose_model = YOLO(r"/jupyter files/yolov8n-pose.pt")

def check_person(req):
    yolo_model.predict(req.FILES["frame"], classes=(0,))[0]
...
def predictt(path):
    ...
    state_dict = torch.load(r"C:\Users\Ajay\Downloads\checkpoint (1).pt", map_location=torch.device('cpu'))
